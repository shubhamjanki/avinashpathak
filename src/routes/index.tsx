...
const SOCIALS = [
  {
    ...
    handle: "@theUHOHouse",
    url: "https://twitter.com/theUHOHouse",
    desc: "Daily commentary on law, policy and civic life.",
  },
  {
    name: "Instagram",
    handle: "@theuhohouse",
    url: "https://instagram.com/theuhohouse",
    desc: "Behind the chambers — court days, tree-planting drives and community work.",
  },
  {
    name: "LinkedIn",
    handle: "Adv. Avinash Pathak",
    url: "#",
    desc: "Professional updates, articles on jurisprudence and network.",
  },
  {
    name: "Blogspot",
    handle: "Notes & essays",
...
function SocialIcon({ name }: { name: string }) {
  const paths: Record<string, string> = {
    ...
    Blogspot:
      "M6 3h12a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm0 2v14h12V5H6zm2 2h8v2H8V7zm0 4h8v2H8v-2zm0 4h5v2H8v-2z",
  };
  return (
