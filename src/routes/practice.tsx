...
export const Route = createFileRoute("/practice")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Practice areas of Advocate Avinash Pathak: criminal defence, corporate advisory, constitutional and human-rights litigation before the Supreme Court and High Courts." },
      { property: "og:title", content: "Practice Areas — Adv. Avinash Pathak" },
...
const AREAS = [
  ...
  },
  {
    ...
    body: "Writ petitions, public interest litigation, and human-rights matters filed as part of the chambers' civic mandate. The practice regularly represents individuals and non-profits pro bono where fundamental rights are at stake.",
