...
export const Route = createFileRoute("/initiatives")({
  head: () => ({
    meta: [
      { title: "Initiatives — Advocate Avinash Pathak" },
      { name: "description", content: "The civic initiatives of Advocate Avinash Pathak — Green Bharat Great Bharat, Saturday for Society, and the Pathak Temple Martial Arts Monastery." },
      { property: "og:title", content: "Initiatives — Avinash Pathak" },
      { property: "og:description", content: "Civic work beyond the courtroom." },
    ],
  }),
...
const INITIATIVES = [
  ...
  },
  {
    ...
    body: "A traditional martial-arts monastery founded alongside the chambers — training for youth in the region, free of cost, in the older Indian schools of unarmed practice.",
  },
];
    ...
    <>
      <section className="mx-auto max-w-7xl px-6 pt-14 pb-16">
        ...
        <p className="mt-8 max-w-2xl text-lg leading-relaxed text-paper/75">
          Three commitments, one shared premise: law is a form of care.
        </p>
      </section>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 md:grid-cols-12">
          ...
          <div className="md:col-span-7 flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-navy/85">
              The founding text of this civic work, written when Avinash was fifteen. Its central argument — that a civilization ought to be measured by its trees, its water, and the smallest voice it protects — remains the chambers' unofficial constitution.
            </p>
